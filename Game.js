...
class Game {
    ...
    constructor () {
        ...
        //Nuevo atributo score con puntuación inicial de 0
        this.score = 0;
    }
    ...
    start () {
        if (!this.started) {
            ...
            //Imprimir en pantalla los resultados de score y lives:
    ...
    endGame () {
        ...
        if (this.player.lives === 0){
            new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_OVER_PICTURE).render();
        } else {
            new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_WIN_PICTURE).render();
        }
